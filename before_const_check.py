...
def build_master(iteration_data):
    ...
    lamda_Ben = 50
    model.lambda_benders = pyo.Param(initialize=lamda_Ben) # Penalty for violating Benders cuts
    ...
    model.beta = pyo.Var(within=pyo.Reals, bounds=(10, 1e5)) # Continuous variable for beta
