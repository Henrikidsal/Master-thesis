...
model.Lambda = pyo.Param(initialize=1e4, mutable=True)  
model.RHS_cut1 = pyo.Param(initialize=235.7, mutable=True)  
model.RHS_cut2 = pyo.Param(initialize=185.1, mutable=True)  
model.RHS_cut3 = pyo.Param(initialize=364.49, mutable=True)

model.beta = pyo.Var(domain=pyo.Integers)
model.slack_cut1 = pyo.Var(domain=pyo.Reals, bounds=(0, None))
model.slack_cut2 = pyo.Var(domain=pyo.Reals, bounds=(0, None))  
model.slack_cut3 = pyo.Var(domain=pyo.Reals, bounds=(0, None)) 
