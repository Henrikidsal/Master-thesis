...
logic1_penalty = 5000000
logic2_penalty = 5000000
demand_penalty = 5000
ramp_up_penalty = 500
ramp_down_penalty = 500
...
# Uncomment the following lines to print graphs or the solution list if desired
