...
def objective(trial):
    ...
    logic1_penalty = trial.suggest_float("logic1_penalty", 0.0001, 3)
    logic2_penalty = trial.suggest_float("logic2_penalty", 0.0001, 3)
    demand_penalty  = trial.suggest_float("demand_penalty",  0.0001, 3)
    ramp_up_penalty = trial.suggest_float("ramp_up_penalty", 0.0001, 3)
    ramp_down_penalty = trial.suggest_float("ramp_down_penalty", 0.0001, 3)
